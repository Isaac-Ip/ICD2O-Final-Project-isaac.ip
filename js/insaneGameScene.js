...
// Created by: Isaac Ip
// Created on: Apr 2025
// This is the Insane Difficulty Game Scene

/**
 * This class is the Insane Difficulty Game Scene.
 */
class InsaneGameScene extends Phaser.Scene {
  ...
  constructor () {
    ...
    this.luck = null
    this.luckFade = null
    this.luckPulse1 = null
    this.luckPulse2 = null
    this.luckPulse3 = null
    this.luckUsed = false
    this.luckColor = null
    this.cooldown3 = null
    this.cooldown2 = null
  ...
  preload () {
    ...
    this.load.image('luck', 'assets/luck.png')
    this.load.image('luckFade', 'assets/luck-fade.png')
    this.load.image('luckColor', 'assets/luck-color.png')
    this.load.image('luckPulse1', 'assets/luck-pulse-1.png')
    this.load.image('luckPulse2', 'assets/luck-pulse-2.png')
    this.load.image('luckPulse3', 'assets/luck-pulse-3.png')
  ...
  create (data) {
    ...
    this.luck = this.add.sprite(1920 - 680, 1080 - 930, 'luck').setInteractive()
    this.luck.on('pointerdown', () => this.clickLuckButton())
  ...
  clickLuckButton () {
    ...
    this.luck.destroy()
    this.luck = null
    this.luckFade = this.add.sprite(1920 - 680, 1080 - 930, 'luckFade').setInteractive()
    setTimeout(() => { this.luckFade.destroy() }, 100)
    setTimeout(() => { this.luckFade = null }, 100)
    setTimeout(() => { this.luckPulse1 = this.add.sprite(1920 - 680, 1080 - 930, 'luckPulse1').setInteractive() }, 100)
    setTimeout(() => { this.luckPulse1 = this.luckPulse1.destroy() }, 200)
    setTimeout(() => { this.luckPulse1 = this.luckPulse1 = null }, 200)
    setTimeout(() => { this.luckPulse2 = this.add.sprite(1920 - 680, 1080 - 930, 'luckPulse2').setInteractive() }, 200)
    setTimeout(() => { this.luckPulse2 = this.luckPulse2.destroy() }, 300)
    setTimeout(() => { this.luckPulse2 = this.luckPulse2 = null }, 300)
    setTimeout(() => { this.luckPulse3 = this.add.sprite(1920 - 680, 1080 - 930, 'luckPulse3').setInteractive() }, 300)
    setTimeout(() => { this.luckPulse3 = this.luckPulse3.destroy() }, 400)
    setTimeout(() => { this.luckPulse3 = this.luckPulse3 = null }, 400)
    setTimeout(() => { this.luckColor = this.add.sprite(1920 - 680, 1080 - 930, 'luckColor').setInteractive() }, 400)
  }
  ...
  clickFireButton () {
    ...
    if (this.spinNumber === 0) {
      ...
      if (this.luckColor) {
        this.luckColor.destroy()
      }
      if (this.luckUsed === true && this.luckCooldown === 0) {
        this.bossDeadlyBullet = Math.floor(Math.random() * 3) + 1
        this.bossSelectedBullet = Math.floor(Math.random() * 3) + 1
        this.luckCooldown = 3
        this.cooldown3 = this.add.sprite(1920 - 680, 1080 - 930, 'cooldown3')
      } else if (this.luckCooldown === 3) {
        this.bossDeadlyBullet = Math.floor(Math.random() * 6) + 1
        this.bossSelectedBullet = Math.floor(Math.random() * 6) + 1
        this.luckCooldown = 2
        this.cooldown2 = this.add.sprite(1920 - 680, 1080 - 930, 'cooldown2')
      } else if (this.luckCooldown === 2) {
        this.bossDeadlyBullet = Math.floor(Math.random() * 6) + 1
        this.bossSelectedBullet = Math.floor(Math.random() * 6) + 1
        this.luckCooldown = 1
        this.cooldown1 = this.add.sprite(1920 - 680, 1080 - 930, 'cooldown1')
      } else if (this.luckCooldown === 1) {
        this.bossDeadlyBullet = Math.floor(Math.random() * 6) + 1
        this.bossSelectedBullet = Math.floor(Math.random() * 6) + 1
        this.luckCooldown = 0
        this.luck = this.add.sprite(1920 - 680, 1080 - 930, 'luck').setInteractive()
...
export default InsaneGameScene
