...
// Created by: Isaac Ip
// Created on: Apr 2025
// This is the Hidden Minigame Scene

/**
 * This class is the Hidden Minigame Scene.
 */
class HiddenMinigameScene extends Phaser.Scene {
  /**
  ...
  constructor () {
    ...
    this.playerWithGuns = null
    this.bossFirstPhase = null
    this.bossSecondPhase = null
   ...
   */
  preload () {
    console.log('Hidden Minigame Scene')

    // images
    this.load.image('backgroundImage', './assets/hidden-minigame-background.png')
    this.load.image('bossBullet', 'assets/boss-bullet.png')
    this.load.image('bossFirstPhase', 'assets/boss-bullet.png')
    this.load.image('bossSecondPhase', 'assets/boss-bullet.png')
    this.load.image('playerBullet', 'assets/player-bullet.png')
    this.load.image('playerWithGuns', 'assets/player-with-guns')
   ...
   */
  create (data) {
    this.background = this.add.sprite(0, 0, 'backgroundImage')
...
export default HiddenMinigameScene
